[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22878541.svg)](https://doi.org/10.5281/zenodo.22878541)
...
> **DOI**：DOI:10.5281/zenodo.22878541。本仓库为偏元数学 S3（第三程）数学侧的**第二段**，上承 Day26 `prenary-math-lean-s3-direction-return`（对象层 `ℂ★` · 二态 · 偏元序）与 Day25 `prenary-math-lean-s3-sw-epsilon-eta`（ε↔η 映射）。
